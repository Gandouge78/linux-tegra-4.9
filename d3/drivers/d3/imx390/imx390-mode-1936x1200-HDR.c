...
const struct reg_sequence imx390_mode_1936x1200HDR[] = {
	...
	{0x000D, 0x02},
	{0x000E, 0x00},
	{0x0010, 0xF2},         /* shs 754 lines */
	{0x0011, 0x02},
	{0x0012, 0x00},
	{0x0018, 0x1C},		/* 8.4 dB */
	{0x0019, 0x00},
	{0x001A, 0x0A},		/*JE: was C, changed to A for 3dB per Auto Exposure #1 mode recommendation in Sony Image Tuning Guide*/
	{0x001B, 0x00},
	{0x0038, 0x00},
	{0x003C, 0x00},
	{0x003D, 0x00},
	...
	{0x0141, 0x00},
	{0x0142, 0x00},
	{0x0144, 0xDF},		/* cp1 x 479 */
	{0x0145, 0x01},
	{0x0146, 0x00},
	{0x0148, 0xDF},		/* cp1 y 479 */
	{0x0149, 0x01},
	{0x014A, 0x00},
	{0x014C, 0x9E},		/* cp2 x 1438 */
	{0x014D, 0x05},
	{0x014E, 0x00},
	{0x0150, 0x45},		/* cp2 y 837 */
	{0x0151, 0x03},
	{0x0152, 0x00},
	{0x0154, 0xDB},		/* cp3 x 4315 */
	{0x0155, 0x10},
	{0x0156, 0x00},
	{0x0158, 0xD6},		/* cp3 y 1238 */
	{0x0159, 0x04},
	{0x015A, 0x00},
	{0x015C, 0x91},		/* cp4 x 12945 */
	{0x015D, 0x32},
	{0x015E, 0x00},
	{0x0160, 0x98},		/* cp4 y 1688 */
	{0x0161, 0x06},
	{0x0162, 0x00},
	{0x0164, 0xB4},		/* cp5 x 38836 */
	{0x0165, 0x97},
	{0x0166, 0x00},
	{0x0168, 0x8F},		/* cp5 y 2191 */
	{0x0169, 0x08},
	{0x016A, 0x00},
	{0x016C, 0x1C},		/* cp6 x 116508 */
	{0x016D, 0xC7},
	{0x016E, 0x01},
	{0x0170, 0xC3},		/* cp6 y 2755 */
	{0x0171, 0x0A},
	{0x0172, 0x00},
	{0x0174, 0x55},		/* cp7 x 349525 */
	{0x0175, 0x55},
	{0x0176, 0x05},
	{0x0178, 0x3B},		/* cp7 y 3387 */
	{0x0179, 0x0D},
	{0x017A, 0x00},
	{0x017C, 0xFF},		/* cp8 x 1048575 */
	{0x017D, 0xFF},
	{0x017E, 0x0F},
	{0x0180, 0xFF},		/* cp8 y 4095 */
	{0x0181, 0x0F},
	{0x0182, 0x00},
	{0x0184, 0xFF},		/* 4095 */
	{0x0185, 0xFF},
	...
	{0x2003, 0x05},
	{0x2004, 0x02},
	{0x2008, 0x65},		/* vmax = 0x465 == 1125 */
	{0x2009, 0x04},
	{0x200A, 0x00},
	{0x200C, 0x30},		/* hmax (line period) 0x1130 == 4400  */
	{0x200D, 0x11},
	{0x2010, 0x04},
	{0x2014, 0x01},
	{0x2018, 0x02},
